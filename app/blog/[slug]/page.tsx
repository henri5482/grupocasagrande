...
// Definición de las props para la página con el parámetro dinámico
...
export default function BlogPost({ params }: BlogPostProps) {
  ...
  const blog = blogsData.find((b: Blog) => b.slug === params.slug);
                ...
                <div className="space-y-4">
                  {relatedBlogs.map((relatedBlog: Blog) => (
                    <Link
                      ...
                      passHref
                    >
                      <div className="flex items-center space-x-4 p-4 rounded-lg transition-colors hover:bg-gray-100">

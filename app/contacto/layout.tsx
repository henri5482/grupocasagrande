...
export const metadata: Metadata = {
  title: {
    default: "Contacto| Casagrande",
    template: "%s | Club de Ingenieros",
  },
  description:
    "Certificados avalados y con validez profesional para ingenieros civiles, mecánicos, eléctricos e industriales. Mejora tu currículum con nuestras certificaciones reconocidas.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Obtén tu certificación con validez profesional para procesos laborales y de ascenso en el sector de ingeniería",
    type: "website",
  ...
  twitter: {
    ...
    description:
      "Certificaciones válidas para ingenieros con reconocimiento en el sector industrial",
